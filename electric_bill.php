...
if(isset($_POST['btn1']))
{
  extract($_POST);
   if($amount<=$res2[6])
   {
    ...
    $description="Electic Bill Paid sucessfully to ConsumerId ".$phone2." of amount ".$amount. " provider-".$operator;
    $q2="INSERT INTO `transaction` (`phone`,`description`,`amount`,`type`,`wallet`) VALUES ('$phone', '$description', '$amount', '$type','$wallet')";
    $e2=mysqli_query($conn,$q2);
  if($e2)
  {
    $msg="Electic Bill Paid sucessfully";
  }
  else
  {
    $msg="failed";
           ...
           <strong><?php echo"$msg";?></strong>
               ...
               <form action="" method="post">
                    ...
                    <select class="form-control" name="operator" id="">
                      <option value="BSCDCL">WBSCDCL</option>
